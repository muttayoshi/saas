  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-[var(--radius)] text-sm font-semibold transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        shimmer:
          "bg-primary text-primary-foreground shadow-sm shimmer hover:bg-primary/90 active:scale-[0.98]",
        destructive:
        ...
        gold:
          "bg-gradient-to-r from-amber-400 via-yellow-400 to-amber-500 text-[#0c0f1e] font-bold shadow-lg hover:shadow-amber-400/25 hover:brightness-110 active:scale-[0.98]",
      },
      size: {
